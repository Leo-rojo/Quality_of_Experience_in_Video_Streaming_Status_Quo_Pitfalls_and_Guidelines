...
df = pd.DataFrame(columns=['ABR', 'Mean_bits', 'Mean_logbits', 'Mean_psnr', 'Mean_ssim', 'Mean_vmaf', 'Mean_SDNdash', 'Mean_FTW', 'Mean_videoAtlas', 'Mean_scoresbiqps'])
Save_models_abr=[]
...
#invert the order of the last two columns
...
for column in highest_values:
    v2=round(highest_values[column][0],2)
    v1=round(highest_values[column][1],2)
