...
plt.bar(b, [1,2,3,4,5,6,7,8], color ='r',  width = barWidth-0.1,linewidth=0,label='Realistic IF distribution',align='edge')
plt.bar(c, [1,2,3,4,5,6,7,8], color ='b',  width = barWidth-0.1,linewidth=0,label='Uniform IF distribution',align='edge')
...
figLegend.savefig("legendensity.pdf",bbox_inches='tight')
figLegend.savefig("legendensity.png",bbox_inches='tight')
plt.close()
plt.close()